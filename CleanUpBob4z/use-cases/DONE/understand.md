...
![Bob generates a full GENAPP call graph with a visual diagram and a call graph summary table](../images-sand/understand-1.png)
...
![Bob generates a full transitive call chain tree from LGACDB01 with a call chain table](../images-sand/understand-2.png)
...
![Bob identifies all GENAPP entry points with a diagram and entry point summary table](../images-sand/understand-3.png)
...
![Bob generates a scoped call graph for the Add Customer flow with a narrative breakdown](../images-sand/understand-4.png)
...
![Bob generates a reverse call graph for LGSTSQ showing all callers and a call summary table](../images-sand/understand-5.png)
...
![Bob generates a SQL access graph for LGAPDB01 showing all tables it inserts into with a table access summary](../images-sand/understand-6.png)
...
![Bob generates an impact graph for a POLICY table schema change with a directly impacted components summary](../images-sand/understand-7.png)
...
![Bob identifies all programs affected by a change to lgpolicy.cpy with a risk assessment and key observations](../images-sand/understand-8.png)
...
![Bob generates a copybook inclusion count table and dependency graph ranked by inclusion count](../images-sand/understand-9.png)
...
![Bob generates a full include tree for LGAPDB01 with an include summary table and key observations](../images-sand/understand-10.png)
...
![Bob generates an internal control flow graph for LGAPDB01 with a graph summary table listing each paragraph's role](../images-sand/understand-11.png)
...
![Bob generates the MAINLINE paragraph flow for LGUPDB01 with a direct calls table](../images-sand/understand-12.png)
...
![Bob generates a paragraph execution flow diagram for LGACDB01 with an execution summary table](../images-sand/understand-14.png)
...
![Bob identifies WRITE-ERROR-MESSAGE as the most-called paragraph in LGAPDB01 with a callers table and call graph](../images-sand/understand-15.png)
...
![Bob generates a cyclomatic complexity bar chart and paragraph-level heatmap for the top GENAPP programs](../images-sand/understand-16.png)
...
![Bob generates a cross-program data flow summary for CA-CUSTOMER-NUM with a detailed flow by program table](../images-sand/understand-17.png)
...
![Bob generates a data flow diagram for DB2-CUSTOMERNUM-INT with an annotated flow walkthrough table](../images-sand/understand-18.png)
...
![Bob generates an inter-paragraph data flow diagram for LGAPDB01 with key observations about variable coupling](../images-sand/understand-19.png)
...
![Bob generates an application-wide trace of CA-RETURN-CODE with a return code reference table and program-by-program breakdown](../images-sand/understand-20.png)
...
![Bob generates a CA-POLICY-NUM data flow diagram for LGAPDB01 with a step-by-step narrative table](../images-sand/understand-21.png)

...
In this use case, you'll analyze a production-style CICS/DB2 COBOL program and convert it into a modern Java 21 distributed service — replacing the CICS COMMAREA interface with a Spring Boot REST API, embedded SQL with Spring Data JPA, and downstream CICS LINK calls with an injected service interface.
...
Before starting this use case, ensure the following are installed:
...
> Ensure you are in **Java Modernization** mode
